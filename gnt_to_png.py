...
DATA_PATH = r"D:\date1\chinese-write-handling-char-recognition-master\tupian\HWDB1.1trn_gnt"  # gnt数据文件路径
IMG_PATH = r"D:\date1\tupian"  # 解析后的图片存放路径
